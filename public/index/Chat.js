...
async function getAllMessages(){
    ...
    try{
        console.log('inside')
        const result = await axios.get(`http://54.210.91.135/user/get-chat?group=${group_name}`,{
            headers:{
                authenticate:token
            }
        });
...
async function getNewMessages(){
    ...
    try{
        const result = await axios.get(`http://54.210.91.135/user/get-new-msg?messageId=${messageId}&group=${group_name}`)
...
async function sendMessage(e){
    ...
    let messages = JSON.parse(localStorage.getItem('messages'));
    try{
        const result = await axios.post(`http://54.210.91.135/user/send-msg?group=${group_name}`,{message:message_to_send},{
            headers:{
                authenticate:token
            }
        })
...
async function getAllGroups(){
    ...
    // call showAllGroups
    try{
        const result = await axios.get('http://54.210.91.135/group/get-groups',{
            headers:{
                authenticate:token
            }
        })
...
async function getNewGroups(){
    ...
    //call showNewGroup
    try{
        const result = await axios.get('http://54.210.91.135/group/get-new-groups',{
            headers:{
                authenticate:token
            }
        })
...
async function selectGroup(e){
    ...
    const result = await axios.get(`http://54.210.91.135/group/check-for-admin?group=${group_name}`,{
        headers:{
            authenticate:token
        }
    });
...
async function getAllUsers(){
    ...
    try{
        const result = await axios.get(`http://54.210.91.135/user/get-users?group=${group_name}`,{
            headers:{
                authenticate:token
            }
        })
...
async function getNewUser(){
    ...
    try{
        ...
        const result = await axios.get(`http://54.210.91.135/user/get-new-users?group=${group_name}&userId=${userId}`,{
            headers:{
                authenticate:token
            }
        })
...
async function logout(e){
    ...
    try{
        ...
        const result = await axios.get('http://54.210.91.135/user/log-off',{
            headers:{
                authenticate:token
            }
        })
